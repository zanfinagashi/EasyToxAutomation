$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("features/Fax Queue/verifyNoOfRecordsDisplayed.feature");
formatter.feature({
  "line": 2,
...
formatter.step({
  "line": 8,
  "name": "Verify the default number of records displayed FQ",
  "keyword": "When "
});
formatter.step({
  "line": 9,
  "name": "Default number \u002710\u0027 should be displayed in the dropdown box FQ",
  "keyword": "Then "
});
formatter.step({
  "line": 11,
  "name": "Click on dropdown that shows no of records to be displayed on the page FQ",
  "keyword": "When "
});
formatter.step({
  "line": 12,
  "name": "User should be able to view and select the options from the list and the corresponding number of records should be displayed on the page FQ",
  "keyword": "Then "
});
formatter.match({
...
formatter.match({
  ...
  "location": "VerifyNoOfRecordsDisplayedSteps.default_number_should_be_displayed_in_the_dropdown_box(int)"
});
formatter.result({
  "status": "skipped"
});
