$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("features/Instruments/verifyDataSorting.feature");
formatter.feature({
  "line": 2,
...
formatter.step({
  "line": 8,
  "name": "Click on \u0027˅\u0027 down arrow icon on Sorting column I",
  "keyword": "When "
});
formatter.step({
  "line": 9,
  "name": "Records should be displayed based on the asecending order of the selected field I",
  "keyword": "Then "
});
formatter.step({
  "line": 11,
  "name": "Click on \u0027^\u0027 Up arrow icon on sorting column I",
  "keyword": "When "
});
formatter.step({
  "line": 12,
  "name": "Records should be displayed based on the descending order of the selected field I",
  "keyword": "Then "
});
formatter.match({
