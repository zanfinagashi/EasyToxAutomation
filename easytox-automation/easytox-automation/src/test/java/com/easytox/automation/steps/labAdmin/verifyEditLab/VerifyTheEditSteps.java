...
public class VerifyTheEditSteps {
	...
	@Then("^Update Lab Admin User screen should be displayed successfully and the following information should be displayed on the screen User Information, Personal Information$")
