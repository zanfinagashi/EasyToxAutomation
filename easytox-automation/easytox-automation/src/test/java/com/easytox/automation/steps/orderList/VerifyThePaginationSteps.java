...
public class VerifyThePaginationSteps {
	...
	@When("^Navigate back and forth by selecting page numbers 'Prev/(\\d+),(\\d+),(\\d+)/Next' OL$")
	...
	@Then("^User should be navigate to the selected page OL$")
	...
	@When("^Checking the message of no of records displayed on the current page bottom left corner of the screen OL$")
	...
	@Then("^A text message 'Showing x to y of z entries' should be displayed on the bottom left corner of the list OL$")
